Hola Java tiene sintaxis un poco más "pesada" que Ruby :confused:, pero no te desesperes: ¡con seguridad te va a recordar a Gobstones y JavaScript! Veamos algunos aspectos notables: 
